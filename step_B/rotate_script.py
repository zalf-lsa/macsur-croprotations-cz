...
all_crops = "more_generic_rotation//all_crops.json"
...
for element in range(len(rotation_1_main)):
    ...
    rotations_1st[rot_1_name] = rotation_1 #store rotations
    rotations_2nd[rot_2_name] = rotation_2

    rotation_1_main = rotate(rotation_1_main)
    rotation_2_main = rotate(rotation_2_main)

#out_file_R1 = "rotation1_02.json"
#out_file_R2 = "rotation2_07.json"

#with open(out_file_R1, 'w') as outfile:
#    json.dump(rotations_1st["02"], outfile)

#with open(out_file_R2, 'w') as outfile:
#    json.dump(rotations_2nd["07"], outfile)